        ...
        <div class="shared-header-inner">
          ...
          <nav class="shared-desktop-nav" aria-label="Primary navigation">
            ...
            <div class="services-dropdown">
              <a href="services.html" class="nav-link services-dropdown-trigger" aria-haspopup="true"${current('services.html')}>Services <i class="fas fa-chevron-down services-dropdown-caret" aria-hidden="true"></i></a>
            ...
            <a href="calculator.html" class="nav-link"${current('calculator.html')}>Calculator</a>
      ...
      <aside id="sharedMobileMenu" class="shared-mobile-menu" aria-label="Mobile navigation">
        <div class="p-6">
          ...
          <nav class="flex flex-col gap-1">
            ...
            <a href="services.html" class="shared-mobile-link"${current('services.html')}>Services</a>
            ...
            <a href="calculator.html" class="shared-mobile-link"${current('calculator.html')}>Calculator</a>
